...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <script>
            var adminUC = '<?php echo e($adminUC); ?>';
            if(adminUC != '') {
                window.localStorage.setItem("adminUniqueCode", adminUC);
            }
            var admin_name = '<?php echo e($admin_name); ?>';
            if(admin_name != '') {
...
</html><?php /**PATH C:\XAMPP\htdocs\TRAINZILLA\trainzilla-backend\resources\views/app.blade.php ENDPATH**/ ?>