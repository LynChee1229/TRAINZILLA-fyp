    ...
    <form method="get" action="/updateRoute">
        ...
        <div class="d-flex flex-row mt-3">
            <div>
                ...
                <input type="hidden" name="rid" value="<?php echo e($route->routeID); ?>"/>
                <input type="hidden" value="<?php echo e($route->routeTitle); ?>" id="oldTitle"/>
            </div>
            <div class="ml-3" style="width:380px;">
                <p><input type="text" class="input-group rTitle" placeholder="Insert the route title" size="27" maxlength="48" name="rTitle" value="<?php echo e($route->routeTitle); ?>" required/></p>
                <p class="mt-1"><input type="number" class="input-group" min="1" name="rTrain" id="rTrain" value="<?php echo e($route->routeTrainNum); ?>" required/></p>
            </div>
        </div>

        <div class="row">
            <div class="col-4 leftCard">
                <?php    $max = count($station) - 1 ;    ?>
                
                <?php if(isset($station)): ?>
                <div class="stationCard mt-3">
                    <input class="input-group stationName" name="stationName[]" placeholder="Station Name" size="24" maxlength="48" required value="<?php echo e($station[0]->stationName); ?>"/>
                    <br/><br/>
                    <input type="time" class="input-group setTime" name="stationDeparture[]" required value="<?php echo e($station[0]->stationDeparture); ?>"/>
                </div>
                <?php endif; ?>

                <div class="m-0 p-0 mt-4 newStationCard">
                <?php $__currentLoopData = $station; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if( ($index != 0) && ($index != $max) ): ?>
                    <div class="stationCard mt-3" style="position:relative; margin-top:29px!important;">
                        ...
                        <input class="input-group stationName" name="stationName[]" placeholder="Station Name" size="24" maxlength="48" required value="<?php echo e($station[$index]->stationName); ?>"/>
                        <br/><br/>
                ...
                <div class="stationCard mt-3" style="margin-top:29px!important;">
                    <input class="input-group stationName" name="stationName[]" placeholder="Station Name" size="24" maxlength="48" required value="<?php echo e($station[$max]->stationName); ?>"/>
                    <br/><br/>
                    <input type="time" class="input-group setTime" name="stationDeparture[]" required value="<?php echo e($station[$max]->stationDeparture); ?>"/>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="col-4 rightCard">
                ...
                <div class="stosCard" style="margin-top:92px;">
                    <input type="number" class="input-group stosD" name="stosDistance[]" placeholder="Distance (km)" min="1" step="0.1" required value="<?php echo e($stos[0]['distance']); ?>" />
                    <br/><br/>
                    <div id="seconds">
                        <input type="number" class="setSeconds" name="minutesTaken[]" min="00" max="59" placeholder="-- (minutes)" required value="<?php echo e($stos[0]['minutesTaken']); ?>" /> : 
                        <input type="number" class="setSeconds" name="secondsTaken[]" min="00" max="59" placeholder="-- (seconds)" required value="<?php echo e($stos[0]['secondsTaken']); ?>" />
                    </div>
                </div>
                <?php endif; ?>

                <div class="newStosCard m-0 p-0">
                <?php $__currentLoopData = $stos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($index != 0): ?>
                    <div class="stosCard" style="margin-top:29px;">
                        <input type="number" class="input-group stosD" name="stosDistance[]" placeholder="Distance (km)" min="1" step="0.1" required value="<?php echo e($t['distance']); ?>" />
                        <br/><br/>
                        <div id="seconds">
                            <input type="number" class="setSeconds" name="minutesTaken[]" min="00" max="59" placeholder="-- (minutes)" required value="<?php echo e($t['minutesTaken']); ?>" /> : 
                            <input type="number" class="setSeconds" name="secondsTaken[]" min="00" max="59" placeholder="-- (seconds)" required value="<?php echo e($t['secondsTaken']); ?>" />
                        </div>
                    </div>
                <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\XAMPP\htdocs\TRAINZILLA\trainzilla-backend\resources\views//adminrouteedit.blade.php ENDPATH**/ ?>