...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(session()->has('success')): ?>
        <div class="text-success"><?php echo e(session()->pull('success')); ?></div>
    <?php endif; ?>
    ...
    <table class="table table-bordered table-striped" id="adminTable">
        ...
        <tr>
            ...
            <td>
                <p><?php echo e($l->adminName); ?> 
                <?php if($l->adminStatus == '1'): ?>
                    <span class="ml-2 activeStatus">Active</span>
                <?php elseif($l->adminStatus == '0'): ?>
                    <span class="ml-2 inactiveStatus">Inactive</span>
                <?php endif; ?>
                </p>
            </td>
            <td>
                <p><?php echo e($l->adminEmail); ?></p>
            </td>
            <td>
                <p>(+60) <?php echo e($l->adminContact); ?></p>
            </td>
            <td>
                <p style="text-align: center;">
                    <input type="hidden" id="aid" value="<?php echo e($l->adminUniqueCode); ?>"/>
                    <input type="hidden" id="aname" value="<?php echo e($l->adminName); ?>"/>
                <?php if($l->adminStatus == '1'): ?>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\XAMPP\htdocs\TRAINZILLA\trainzilla-backend\resources\views/adminlist.blade.php ENDPATH**/ ?>