    ...
    <form method="get" action="#">
        ...
        <div class="d-flex flex-row mt-3">
            ...
            <div class="ml-3" style="width:380px;">
                <p><input type="text" class="input-group rTitle" placeholder="Insert the route title" size="27" maxlength="48" name="rTitle" value="<?php echo e($route->routeTile); ?>" required/></p>
                <p class="mt-1"><input type="number" class="input-group" value="1" min="1" name="rTrain" id="rTrain" value="<?php echo e($route->routeTrainNum); ?>" required/></p>
            </div>
        </div>
