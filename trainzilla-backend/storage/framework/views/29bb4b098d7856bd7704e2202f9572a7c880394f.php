    ...
    <div class="mt-5">
        <table class="table table-bordered table-striped" id="ruleTable">
            ...
            <tr>
                ...
                <td>
                    <p style="word-break: break-word;" class="titleD"><?php echo e($l->ruleTitle); ?> 
                    <?php if($l->ruleStatus == '1'): ?>
                        <span class="ml-2 activeStatus">Active</span>
                    <?php elseif($l->ruleStatus == '0'): ?>
                        <span class="ml-2 inactiveStatus">Inactive</span>
                    <?php endif; ?>
                    </p>
                </td>
                <td>
                    <p style="word-break: break-word;"><?php echo e($l->ruleDetails); ?></p>
                </td>
                <td>
                    <div style="color:#A0A0A0;"><small><em>Last updated at</em></small></div>
                    <div><?php echo e($l->ruleDate); ?></div>
                    <p style="color:#000099;"><small><em>by</em> <?php echo e($l->adminName); ?></small></p>
                </td>
                <td style="text-align:center;">
                    <div>
                        <button class="btn blue-btn editBtn mb-2 font-weight-bold" data-toggle="modal" data-target="#editRuleModal" value="<?php echo e($l->ruleID); ?>">EDIT</button>
                        <button class="btn p-0 m-0 mr-2 dltBtn" style="margin-bottom:12px!important;" data-toggle="modal" data-target="#dltModal" value="<?php echo e($l->ruleID); ?>">
                    ...
                    <form method="get" action="/changeRuleStatus">
                        ...
                        <input type="hidden" name="rid" value="<?php echo e($l->ruleID); ?>"/>
                        <p>
                        <?php if($l->ruleStatus == '1'): ?>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\XAMPP\htdocs\TRAINZILLA\trainzilla-backend\resources\views/adminrule.blade.php ENDPATH**/ ?>