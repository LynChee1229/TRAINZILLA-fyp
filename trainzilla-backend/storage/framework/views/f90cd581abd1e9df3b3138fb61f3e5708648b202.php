    ...
    <div class="mt-4">
        <table class="table table-bordered table-striped" id="userTable">
            ...
            <tr>
                ...
                <td>
                    <p><?php echo e($l->userPoint); ?> point(s) 
                    ...
                    <?php echo e($l->userVoucher); ?> voucher(s)</p>
                </td>
                <td style="text-align:center;">
                    <div>
                        <form method="get" action="/changeUserStatus">
                            <button type="button" class="btn blue-btn bookingBtn mb-2 font-weight-bold" data-toggle="modal" data-target="#bookingHistoryModal" value="<?php echo e($l->userUniqueCode); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye mb-1" viewBox="0 0 16 16">
