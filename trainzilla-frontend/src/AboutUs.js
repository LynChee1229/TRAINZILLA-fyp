        ...
        return (
            ...
            <div style={{ backgroundImage: "url(/img/aboutusBG.png)", minHeight:"1580px" }} id="aboutUsBG">
                <div>
                    ...
                    <p style={{ margin:0 }}><img src={logoDark} alt="logo" style={{ maxHeight:"92px" }}/></p>
                    ...
                    <div className="container teamPic">
                        <div className="row" style={{ paddingTop:"5%" }}>
                            <div className="col-md cDesc py-3">
                    ...
                    <div>
                        <div className="thanksTT m-auto">  · especially thanks to ·</div>
                        <div className="p-4 row align-items-center" style={{ fontSize:"1.2em",  maxWidth:"460px", margin:"auto" }}>
                            <div className="col-lg-4 col m-0 p-0">
                                <img src={supervisor} alt="ms suraya" class="mdmPic mx-2"/>
                            </div>
                            <div className="col-lg-8 col m-0 p-0">
                                <strong>Ms. Suraya <br/> Nurain Binti Kalid</strong>
                            </div>
                        </div>
                        <div className="px-4" style={{ maxWidth:"520px", margin:"auto", paddingBottom:"85px" }}>"We are very grateful for your time to guide us, and all your efforts to help us improve. We will never forget your support and kindness. Thank you, Ms. Suraya!" - Trainzilla Develop Team</div>
                    </div>
                </div>
            </div>
            </>
